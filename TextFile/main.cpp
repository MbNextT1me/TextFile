...
int main()
{
	...
	//txt1.addToTheEndOfFile(txt2);

	//not ready!
	// TextFile txt1("test.dat", TextFile::TextFileState::out);
	// if (!txt1.is_open()) return 1;
	//txt1.sortColumn(TextFile::SortState::up, 4);
	//txt1.sumRowInCol(TextFile::SortState::up, 1);
